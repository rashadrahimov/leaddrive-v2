        ...
        <div className="p-3">
          ...
          <div className="flex items-center gap-1.5 mb-1.5">
            ...
            <div>
              ...
              <span className="text-[6px] text-slate-500">AlGroup</span>
            </div>
          </div>
              ...
              {offers.map((offer, i) => (
                <div key={i} className="flex items-center gap-2 p-1 rounded-md bg-slate-50 border border-slate-100">
                  ...
                  <div className="flex-shrink-0">
                    <div className={cn(
                      "w-6 h-6 rounded-full flex items-center justify-center text-[5px] font-bold",
                  ...
                  <div className="text-[5px] text-slate-400 flex-shrink-0">{offer.type}</div>
                </div>
              ))}
            </div>
          </div>
