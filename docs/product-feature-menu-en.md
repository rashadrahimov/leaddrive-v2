...
> Total: **128 features** | **16 Da Vinci features** | **3 algorithmic Da Vinci**
...
| 16 | Next Best Offers (Da Vinci algo) | ★★★★★ | Recommendations: what else to offer the client |
...
| 3 | Da Vinci Ticket Agent | Haiku 4.5 | ★★★★★ | Auto-reply + summary + troubleshooting from KB |
...
| # | Feature | DV? | Uniq. | Description |
|---|---------|-----|-------|-------------|
| 1 | Portal Da Vinci Chat | Sonnet 4.6 | ★★★★★ | 24/7 Da Vinci support with auto-escalation to ticket |
...
## DA VINCI ENGINE (12 features)

| # | Feature | Da Vinci Model | Uniq. | Description |
|---|---------|----------|-------|-------------|
| 1 | Da Vinci Command Center | Infra | ★★★★★ | Agent management, models, prompts, guardrails |
| 2 | Da Vinci Chat Assistant | Sonnet 4.6 | ★★★★★ | CRM-aware chatbot on dashboard |
| 3 | Da Vinci Lead Scoring | Sonnet 4.6 | ★★★★★ | Lead scoring A-F with reasoning |
| 4 | Da Vinci Sentiment Analysis | Haiku 4.5 | ★★★★★ | Positive/Neutral/Negative + trend + risk |
| 5 | Da Vinci Smart Tasks | Haiku 4.5 | ★★★★★ | Auto-generate 4 tasks for manager |
| 6 | Da Vinci Text Generation | Haiku 4.5 | ★★★★☆ | Email/SMS with tone in 3 languages |
| 7 | Da Vinci Support Agent | Haiku 4.5 | ★★★★★ | Auto-replies + summary + KB lookup |
| 8 | Da Vinci Portal Support | Sonnet 4.6 | ★★★★★ | 24/7 chat with escalation |
| 9 | Da Vinci Interaction Logs | Infra | ★★★★☆ | Tokens, cost, latency tracking |
| 10 | Da Vinci Guardrails | Infra | ★★★★☆ | Content safety rules |
| 11 | Da Vinci Alerts | Infra | ★★★☆☆ | Notifications on Da Vinci behavior |
| 12 | Da Vinci Config Form | Infra | ★★★★☆ | No-code agent configuration UI |
...
| 24 | Budget Da Vinci Narrative | Sonnet | ★★★★★ | Da Vinci writes: "Revenue grew 12% due to..." |
...
| 31 | Da Vinci Profitability Insights | Haiku 4.5 | ★★★★★ | "Client X became unprofitable due to 23% overhead growth" |
...
| Category | Features | With Da Vinci |
|----------|----------|---------|
| Finance (operational) | 32 | 1 algo |
| Support & Service Desk | 8 | 1 Da Vinci |
| Customer Portal | 6 | 1 Da Vinci |
| Communication | 4 | — |
| Marketing & Campaigns | 13 | — |
| Sales / CRM Core | 29 | 2 algo |
| Da Vinci Engine | 12 | 8 Da Vinci |
| Analytics (Budget + Profit) | 34 | 3 Da Vinci |
| ERP / Projects | 3 | — |
